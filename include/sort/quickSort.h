...
namespace dsa {
	...
	auto partition(IteratorType begin, IteratorType end, CompFuncType && cmp) -> IteratorType {
	...
	void quickSort(IteratorType begin, IteratorType end, CompFuncType && cmp = CompFuncType {}) {
		if (end - begin < 2) {
			return;
		}
